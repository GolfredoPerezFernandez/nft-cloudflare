...
const Footer = () => {
    return (
      <footer className="relative p-20   overflow-hidden text-black py-6">
        ...
        <div className="pl-20 pt-20 pr-20 container mx-auto px-4 flex flex-col items-center relative z-10">
          ...
          <div className="my-2">
            <span className="text-black">For partnerships, please get in touch with us at <span className="text-[#0066FF]">info@joinxentro.com</span></span>
          </div>
          <div>
            <span className="text-black text-[12px]">Copyright © 2024 Xentro. All rights reserved.</span>
          </div>
        </div>
      </footer>
    );
