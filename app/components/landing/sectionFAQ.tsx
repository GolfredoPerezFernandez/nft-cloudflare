  ...
  return (
    <div className="container">
      <Accordion type="single" collapsible className="w-full p-20">
          ...
          <AccordionTrigger className="text-black">How does Xentro ensure the security of my funds?</AccordionTrigger>
          <AccordionContent className="text-black">
          ...
          <AccordionTrigger className="text-black">What does non-custodial management mean for my assets?</AccordionTrigger>
          <AccordionContent className="text-black">
          ...
          <AccordionTrigger className="text-black"> Do I need prior experience with blockchain to use Xentro?</AccordionTrigger>
          <AccordionContent className="text-black">
          ...
          <AccordionTrigger className="text-black">What types of financial services are available on Xentro?</AccordionTrigger>
          <AccordionContent className="text-black">
          ...
          <AccordionTrigger className="text-black">What kind of analytics does Xentro offer?</AccordionTrigger>
          <AccordionContent className="text-black">
          ...
          <AccordionTrigger className="text-black"> How can I get support if I encounter any issues?</AccordionTrigger>
          <AccordionContent className="text-black">
