...
export default function SectionFAQ() {
  return (
    <div className="container mb-20 mx-auto px-4 sm:px-6 md:px-8 lg:px-10 xl:px-12 mt-10">
      <Accordion type="single" collapsible className="w-full p-6 md:p-10 lg:p-20 bg-[#001133] rounded-lg shadow-lg">
        <AccordionItem value="item-1">
          <AccordionTrigger className="text-white font-bold">What is Xentro?</AccordionTrigger>
        ...
        <AccordionItem value="item-2">
          <AccordionTrigger className="text-white font-bold">How does Xentro ensure the security of my funds?</AccordionTrigger>
          <AccordionContent className="text-white">
        ...
        <AccordionItem value="item-3">
          <AccordionTrigger className="text-white font-bold">What does non-custodial management mean for my assets?</AccordionTrigger>
          <AccordionContent className="text-white">
        ...
        <AccordionItem value="item-4">
          <AccordionTrigger className="text-white font-bold">Do I need prior experience with blockchain to use Xentro?</AccordionTrigger>
          <AccordionContent className="text-white">
        ...
        <AccordionItem value="item-5">
          <AccordionTrigger className="text-white font-bold">What types of financial services are available on Xentro?</AccordionTrigger>
          <AccordionContent className="text-white">
        ...
        <AccordionItem value="item-6">
          <AccordionTrigger className="text-white font-bold">What kind of analytics does Xentro offer?</AccordionTrigger>
          <AccordionContent className="text-white">
        ...
        <AccordionItem value="item-7">
          <AccordionTrigger className="text-white font-bold">How can I get support if I encounter any issues?</AccordionTrigger>
          <AccordionContent className="text-white">
